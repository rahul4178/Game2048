...
export default class g2048C extends React.Component {
    constructor(props) {
      super(props);
       this.undostack = [];
      let redostack = [];
    ...
    let tempundo = []
        if(JSON.stringify(updated) !== JSON.stringify(original) == true){
            this.undostack.push(10)
           console.log("printing undo") 
    ...
    render(){
        ...
        if(this.state.message != null){
                isgameover = <div className="gameOver">{this.state.message}</div>
        }
        return(
            <div className="game">
                <h1>2048 Game</h1>
                <div class="button" onClick={()=>this.initBoard()}>
                    New Game 
                </div>
                <div className = "Box" >
                   
                            <div>
                            {this.state.board.map((row1) =>{
                            return(
                                <Block  rowdata = {row1}>
